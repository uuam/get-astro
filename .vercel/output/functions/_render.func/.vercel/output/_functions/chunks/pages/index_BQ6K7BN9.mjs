/* empty css                          */
import { c as createAstro, d as createComponent, r as renderTemplate, e as renderComponent, m as maybeRenderHead, f as addAttribute } from '../astro_BRE8bGTY.mjs';
...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../posts/post-1.md": () => import('./post-1_Cl7kJoVM.mjs').then(n => n.p),"../posts/post-2.md": () => import('./post-2_BVnHA1Ya.mjs'),"../posts/post-3.md": () => import('./post-3_ipu441LF.mjs'),"../posts/post-4.md": () => import('./post-4_BPh5Jtkv.mjs')}), () => "../posts/*.md");
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "pageTitle": pageTitle }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<h2>My awesome blog subtitle</h2> ${renderComponent($$result2, "Greeting", Greeting, { "client:visible": true, "messages": ["Hi", "Hello", "Howdy", "Hey there"], "client:component-hydration": "visible", "client:component-path": "/Users/uuam/Desktop/order_pos/astro-test/src/components/Greeting", "client:component-export": "default" })} ` })}`;

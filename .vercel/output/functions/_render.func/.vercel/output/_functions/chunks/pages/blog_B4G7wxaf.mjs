/* empty css                          */
import { c as createAstro, d as createComponent, r as renderTemplate, e as renderComponent, m as maybeRenderHead } from '../astro_CriIIjsb.mjs';
import { a as $$BlogPost, $ as $$BaseLayout } from './_tag__Cgd0KWmy.mjs';

const $$Astro = createAstro("https://get-astro.vercel.app/");
const $$Blog = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Blog;
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"./posts/post-1.md": () => import('./post-1_DmL7Gv4D.mjs').then(n => n.p),"./posts/post-2.md": () => import('./post-2_BrQkcQyp.mjs'),"./posts/post-3.md": () => import('./post-3_DzErgwlr.mjs'),"./posts/post-4.md": () => import('./post-4_C-FZq3Kq.mjs')}), () => "../pages/posts/*.md");
